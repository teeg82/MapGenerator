...
public abstract class QuadTree<G extends QuadTree.GeometricObject> {
    ...
    public static abstract class QuadNode<G extends QuadTree.GeometricObject> implements Comparable<QuadNode<G>> {
        ...
        public QuadNode<G> getNorthWest(){
        	return this.northWest;
        }
        
        public QuadNode<G> getNorthEast(){
        	return this.northEast;
        }
        
        public QuadNode<G> getSouthWest(){
        	return this.southWest;
        }
        
        public QuadNode<G> getSouthEast(){
